...
<html lang="hu" dir="ltr">
  ...
  <nav class="navbar navbar-expand bg-dark navbar-dark">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="index.php" style="background-color: gray;">Főoldal</a>
      </li>
      <li class="nav-item">
      ...
      <div class="row text-center">
        <div class="col">
          ...
          <p>
            ...
            Ha még nem regisztrált nálunk, akkor itt az idő! Amennyiben regisztrálás nélkül szeretne rendelni, akkor egyszerüen nyomjon a vásárolok gombra.
          </p>
          <a href="vasarlas.php" class="btn btn-success">Vásárolok!</a>
          <a href="belepes.php" class="btn btn-primary">Regisztrálok!</a>
        </div>
      </div>
    </section>
  </body>
